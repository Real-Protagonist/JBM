                ...
                <div class="col-12 col-lg-3">
                    <div class="contact-content mb-100">
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            ...
                            <p>Sector Ponta; Murtala Muhamede, Luanda</p>
                        </div>
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            ...
                            <p>(+244) 941 745 581 <br>(+244) 941 745 581</p>
                        </div>
        ...
        <div class="container">
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-12 col-md-6">
                    <a href="#">
                        <!-- <img src="img/core-img/JABBA.jpg" alt=""> -->
                        <P style="color:#fff">JABBA-MUSIC</P>
                    </a>
                    <p class="copywrite-text">
						<a href="#">
							Copyright &copy;2022 by <a href="#" target="_blank">StarTech Corp.
						</a>
					</p>
                </div>
