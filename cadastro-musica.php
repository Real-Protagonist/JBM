        ...
        <div class="container">
            ...
            ?>
                    ...
                    <form action="upload.php"  enctype="multipart/form-data" method="POST">
                        ...
                        <br><br>
                        <label for="fmusica" class="h6">Selecione a Musica*</label>
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" onclick="act()" class="form-check-input verif" name="verif" id="exampleCheck1">
                            <label class="form-check-label h6" for="exampleCheck1">Tens certeza que esta música é tua? </label>
                        </div>

                        <input type="submit" class="btn btn-dark env" disabled name="enviar" value="Cadastrar Musica">
                    </form>
                </div>
            </div>
        </div>
